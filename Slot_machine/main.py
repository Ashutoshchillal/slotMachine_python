...
def get_slot_machine_spin(rows, cols, symbols):
    ...
    #To store all symbol values in a single list
...
def deposit():
    while True:
        ...
        if amount.isdigit():
            ...
            print("Enter the amount in integer form")
    ...
    while True:
        ...
        if lines.isdigit():
            ...
            if lines > 0 and lines <= MAX_LINES:
                ...
                print("Enter line between (1 -"+str(MAX_LINES)+")")
        else:
            print("Enter the line numbers in integer form")
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"Insufficient Balance :${remaining}. Enter amount under ${balance}")
        else:
            break
    ...
    winning, winning_lines = check_winnings(slot, lines, bet, symbol_value)
